<script setup>
    ...
    //         },
    //         resizeInitialAdSize(left, top, width, height){
    //             this.adWidth = width
    //             this.adHeight = height
    //             this.adLeft = left-this.offsetLeft
    //             this.adTop = top-this.offsetTop

    //         },
    //         dragInitialAdSize(left, top){
    //             this.adLeft = left-this.offsetLeft
    //             this.adTop = top-this.offsetTop

    //         },
    //         resizeMaxAdSize(left, top, width, height){
    //             this.adMaxWidth = width
    //             this.adMaxHeight = height
    //             this.adMaxLeft = left - this.offsetLeft
    //             this.adMaxTop = top - this.offsetTop
    //         },
    //         dragMaxAdSize(left, top){
    //             this.adMaxLeft = left - this.offsetLeft
    //             this.adMaxTop = top - this.offsetTop
    //         },
    //         resizeScreensize(left, top, width, height){
    //             this.screenWidth = width
    //             this.screenHeight = height
                
    //         },
    //         dragScreensize(left, top){
