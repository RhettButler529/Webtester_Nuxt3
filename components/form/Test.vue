...
//         },
//         toggleOrientationTiming(){
//             if (this.state == 't-off') {
                
//                 this.timer = prompt("Enter number of milliseconds to update orientation state", 1000);
//                 this.interval = setInterval(this.toggleOrientation, this.timer);
//                 this.state = "t-on"
//             } else {
